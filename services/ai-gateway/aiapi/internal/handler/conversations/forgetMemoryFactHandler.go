...
func ForgetMemoryFactHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ForgetMemoryFactRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := conversations.NewForgetMemoryFactLogic(r.Context(), svcCtx)
		resp, err := l.ForgetMemoryFact(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
