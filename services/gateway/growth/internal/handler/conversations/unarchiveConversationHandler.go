...
func UnarchiveConversationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := conversations.NewUnarchiveConversationLogic(r.Context(), svcCtx)
		resp, err := l.UnarchiveConversation(&req)
		if err != nil {
