...
DO UPDATE SET
    ...
    coach_tone = COALESCE(NULLIF($3::text, ''), coaching_profiles.coach_tone),
    difficulty = COALESCE(NULLIF($4::text, ''), coaching_profiles.difficulty),
    primary_motivation = COALESCE($5::text, coaching_profiles.primary_motivation),
    common_blockers = COALESCE($6::jsonb, coaching_profiles.common_blockers),
    coaching_notes = COALESCE($7::jsonb, coaching_profiles.coaching_notes),
