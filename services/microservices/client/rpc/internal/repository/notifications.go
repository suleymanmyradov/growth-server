...
func (r *NotificationsRepo) ListNotifications(ctx context.Context, limit, offset int32) ([]db.ListNotificationsRow, error) {
...
func (r *NotificationsRepo) ListNotificationsByUser(ctx context.Context, userID uuid.UUID, limit, offset int32) ([]db.ListNotificationsByUserRow, error) {
...
func (r *NotificationsRepo) ListNotificationsByType(ctx context.Context, userID uuid.UUID, itemType string, limit, offset int32) ([]db.ListNotificationsByTypeRow, error) {
...
func (r *NotificationsRepo) GetNotificationByID(ctx context.Context, id uuid.UUID) (db.GetNotificationRow, error) {
	ctx, span := trace.TracerFromContext(ctx).Start(ctx, "NotificationsRepo.GetNotificationByID")
	defer span.End()
