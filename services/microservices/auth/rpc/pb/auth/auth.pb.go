...
const file_services_microservices_auth_api_v1_auth_proto_rawDesc = "" +
	"\n" +
	"-services/microservices/auth/api/v1/auth.proto\x12\x04auth\"|\n" +
...
var (
	...
	file_services_microservices_auth_api_v1_auth_proto_rawDescData []byte
)
...
func file_services_microservices_auth_api_v1_auth_proto_rawDescGZIP() []byte {
	file_services_microservices_auth_api_v1_auth_proto_rawDescOnce.Do(func() {
		file_services_microservices_auth_api_v1_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_microservices_auth_api_v1_auth_proto_rawDesc), len(file_services_microservices_auth_api_v1_auth_proto_rawDesc)))
	})
	return file_services_microservices_auth_api_v1_auth_proto_rawDescData
}

var file_services_microservices_auth_api_v1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_services_microservices_auth_api_v1_auth_proto_goTypes = []any{
	...
	(*UpdateProfileResponse)(nil), // 11: auth.UpdateProfileResponse
	...
	(*EmptyResponse)(nil),         // 15: auth.EmptyResponse
}
var file_services_microservices_auth_api_v1_auth_proto_depIdxs = []int32{
	...
	8,  // 8: auth.AuthService.GetProfile:input_type -> auth.GetProfileRequest
	10, // 9: auth.AuthService.UpdateProfile:input_type -> auth.UpdateProfileRequest
	...
	2,  // 13: auth.AuthService.Register:output_type -> auth.AuthResponse
	2,  // 14: auth.AuthService.Login:output_type -> auth.AuthResponse
	2,  // 15: auth.AuthService.RefreshToken:output_type -> auth.AuthResponse
	15, // 16: auth.AuthService.Logout:output_type -> auth.EmptyResponse
	7,  // 17: auth.AuthService.ValidateToken:output_type -> auth.ValidateTokenResponse
	9,  // 18: auth.AuthService.GetProfile:output_type -> auth.GetProfileResponse
	11, // 19: auth.AuthService.UpdateProfile:output_type -> auth.UpdateProfileResponse
	15, // 20: auth.AuthService.ChangePassword:output_type -> auth.EmptyResponse
	15, // 21: auth.AuthService.ForgotPassword:output_type -> auth.EmptyResponse
	15, // 22: auth.AuthService.ResetPassword:output_type -> auth.EmptyResponse
