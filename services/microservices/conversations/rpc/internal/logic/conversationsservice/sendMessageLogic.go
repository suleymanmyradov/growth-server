...
// Message operations
func (l *SendMessageLogic) SendMessage(_ *conversations.SendMessageRequest) (*conversations.SendMessageResponse, error) {
	// todo: add your logic here and delete this line

	return &conversations.SendMessageResponse{}, nil
}
