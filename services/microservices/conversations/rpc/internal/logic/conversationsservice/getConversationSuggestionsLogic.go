...
// AI features
func (l *GetConversationSuggestionsLogic) GetConversationSuggestions(_ *conversations.GetConversationSuggestionsRequest) (*conversations.GetConversationSuggestionsResponse, error) {
