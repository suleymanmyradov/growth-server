...
import (
	...
	articles "gateway/internal/handler/articles"
	auth "gateway/internal/handler/auth"
	conversations "gateway/internal/handler/conversations"
	goals "gateway/internal/handler/goals"
	habits "gateway/internal/handler/habits"
	notifications "gateway/internal/handler/notifications"
	profile "gateway/internal/handler/profile"
	report "gateway/internal/handler/report"
	saved "gateway/internal/handler/saved"
	search "gateway/internal/handler/search"
	settings "gateway/internal/handler/settings"
