...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_goal_habit_relations_habit_id ON goal_habit_relations(habit_id);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_upgrade_events_user_created ON upgrade_events(user_id, created_at DESC);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ai_coach_processed_events_processed_at ON ai_coach_processed_events(processed_at);
...
DROP INDEX CONCURRENTLY IF EXISTS idx_activities_user_id;
